...
class BuildMaster(service.ReconfigurableServiceMixin, service.MasterService):
    ...
    def startService(self):
        ...
        try:
            ...
            #
            #     print('change SIGTERM handle!!!!!!!!!!!!!!!!!!!')
            #     print('1',signal.getsignal(signal.SIGTERM))

            # print("进程号", os.getpid(), os.getppid())
            ...
            #     print('change CTRL_C')
            #     def ctrl_c_event(*args):
            #         eventually(self.reconfig)
            #     signal.signal(signal.CTRL_C_EVENT, ctrl_c_event)
            #     print('change CTRL_C_EVENT handle!!!!!!!!!!!!!!!!!!!', signal.getsignal(signal.CTRL_C_EVENT))

            if hasattr(signal, "SIGABRT"):
                def sigabrt(*args):
                    eventually(self.reconfig)
                # print('run sigabrt')
                signal.signal(signal.SIGABRT, sigabrt)
                # print('change SIGABRT handle!!!!!!!!!!!!!!!!!!!', signal.getsignal(signal.SIGABRT))

            if hasattr(signal, "SIGFPE"):
                def sigfpe(*args):
                    eventually(self.reconfig)
                signal.signal(signal.SIGFPE, sigfpe)
            ...
            if hasattr(signal, "SIGBREAK"):
                ...
                # print('change SIGFPE handle!!!!!!!!!!!!!!!!!!!', signal.getsignal(signal.SIGFPE))
