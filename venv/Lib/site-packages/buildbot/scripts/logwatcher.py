...
class LogWatcher(LineOnlyLongLineReceiver):
    ...
    def start(self):
        ...
        tailBin = 'D:\\buildbot-test\\tail.exe'

        #print(tailBin)

        # self.p = self._reactor.spawnProcess(self.pp, args[0], args)
        ...
        #
        # print('self.p')
        # print('self.p',signal.getsignal(signal.SIGABRT))
    ...
    def finished(self, results):
        # print('finished',signal.getsignal(signal.SIGABRT))
        try:
